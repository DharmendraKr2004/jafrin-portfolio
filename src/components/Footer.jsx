...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Twitter, href: "https://twitter.com/jafrin", label: "Twitter" },
    { icon: Mail, href: "mailto:jafrinshajan2005@gmail.com", label: "Email" },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-text-secondary">
              <p>📧 jafrinshajan2005@gmail.com</p>
              <p>📱 +91 9625217468</p>
        ...
        <div className="border-t border-background-tertiary mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2 text-text-secondary">
            <span>&copy; {currentYear} Jafrin Shajan. Made with</span>
            <motion.div
