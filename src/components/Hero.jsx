...
const Hero = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/Jafrinshajan", label: "GitHub", color: "#333" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/jafrin-shajan-5bb492292", label: "LinkedIn", color: "#0077B5" },
    { icon: Mail, href: "#contact", label: "Email", color: "#EA4335", scrollTo: true },
    { icon: Instagram, href: "https://www.instagram.com/jafrinshajan2005/", label: "Instagram", color: "#E4405F" },
  ]

  const stats = [
    { number: "", label: "Coders Circle", subtitle: "(Manager)", icon: "🎯", isSpecial: true },
    { number: "15+", label: "Certifications", icon: "🏅" },
    { number: "10+", label: "Live Projects", icon: "🚀" },
  ]
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-12 items-center relative z-10">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 md:mb-6">
            ...
            <br />
            <span className="text-text-primary">Shajan</span>
          </motion.h1>
          ...
          <motion.p variants={itemVariants} className="text-base md:text-lg text-text-secondary mb-6 md:mb-8 max-w-lg leading-relaxed">
            Aspiring Web Developer skilled in HTML, CSS, JavaScript, and React.
            Strong foundation in DSA, Python basics, and DBMS.
            Analytical thinker with a background in statistics.
            Skilled in presentation design and basic video editing.
            Creative, adaptable, and eager to grow through real-world projects.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 md:mb-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                {stat.isSpecial ? (
                  <>
                    {stat.number && <div className="text-base sm:text-xl font-bold text-text-accent">{stat.number}</div>}
                    <div className="text-xs sm:text-sm font-bold text-text-accent group-hover:text-text-accent transition-colors duration-300">{stat.label}</div>
                    <div className="text-xs sm:text-sm text-text-secondary/80 group-hover:text-text-accent transition-colors duration-300">{stat.subtitle}</div>
                  </>
                ) : (
                  <>
