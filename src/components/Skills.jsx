...
const Skills = () => {
  ...
  const skillsData = [
    ...
    { name: "Soft Skills", percentage: 90, color: "from-pink-500 to-purple-500" }
  ]
        ...
        >
          ...
          >
            ...
            <p className="text-sm sm:text-base md:text-lg text-text-secondary">
              Currently learning Full-Stack Development | 15+ Certifications Completed
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Strong foundation in C and Python with expertise in Data Structures & Algorithms. Full stack development using React, Node.js, Express, and MongoDB."
              },
              {
                icon: "🏗️",
                title: "Real-World Projects",
                description: "Freelancing experience with multiple Python and AI/ML projects. Building innovative solutions and delivering quality work for clients worldwide."
              },
              {
                icon: "🔗",
                title: "Community Builder & Networking",
                description: "Manager at Coders Circle, a thriving tech community. Connecting developers and fostering collaboration in the tech ecosystem."
              }
            ].map((point, index) => (
              <motion.div
                key={index}
