...
const Projects = () => {
  ...
  const categories = [
    { id: 'all', name: 'All Projects', icon: Code, count: 3 },
    { id: 'web', name: 'Web Apps', icon: Globe, count: 3 },
    { id: 'ai', name: 'AI Projects', icon: Database, count: 0 }
  ]
  ...
  const projects = [
    ...
    {
      id: 4,
      title: "Smart Voting Application",
      description: "Admin dashboard and voting system for secure, streamlined polling — register voters, run polls, view live vote counts, and export results.",
      longDescription: "Smart Voting Application is a web-based voting dashboard designed to manage elections and polls. The interface provides voter registration, voting flow control (start/stop voting), real-time vote statistics, and CSV export for results. The UI focuses on clarity and accessibility with a responsive layout and an admin sidebar for quick navigation.",
      image: "/smart-voting-screenshot.png",
      hasImage: true,
      category: "web",
      ...
      forks: 3,
      views: 150,
      highlights: ["Voter Registration", "Real-time Voting", "CSV Export", "Admin Dashboard"]
    },
    {
      id: 5,
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.a
                  href="https://github.com/Jafrinshajan"
                  target="_blank"
                  rel="noopener noreferrer"
