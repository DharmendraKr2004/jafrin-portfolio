...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const mailtoLink = `mailto:jafrinshajan2005@gmail.com?subject=${subject}&body=${body}`
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      value: 'jafrinshajan2005@gmail.com',
      href: 'mailto:jafrinshajan2005@gmail.com'
    },
    {
      icon: Phone,
      title: 'Phone',
      value: '+91 9625217468',
      href: 'tel:+919625217468'
    },
    {
      icon: MapPin,
      title: 'Location',
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/Jafrinshajan", label: "GitHub" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/jafrin-shajan-5bb492292", label: "LinkedIn" },
    { icon: Twitter, href: "https://chat.whatsapp.com/JuNaszcCNQcHU1pKfEN8Lh", label: "WhatsApp Community" },
    { icon: Instagram, href: "https://www.instagram.com/jafrinshajan2005/", label: "Instagram" },
  ]
